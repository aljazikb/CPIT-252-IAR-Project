 ...
 */
import cpit.login;
import Factory.ProductFactoryCreator;
import Strategy.*;
...
public class AddProduct extends javax.swing.JFrame {
    ...
    private void addProduct() {
        ...
        boolean isAllLetters = type.chars().allMatch(Character::isLetter);
        boolean AllLetters = name.chars().allMatch(Character::isLetter);
        if (!isAllLetters || !AllLetters) {
            JOptionPane.showMessageDialog(this, "Category and Type must consist of letters only.");
            return;
        }
