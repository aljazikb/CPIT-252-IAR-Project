    ...
    private void applyUpdate() {
        ...
        switch (field) {
            ...
            case "QuantityInStock":
                ...
                boolean isAllLetters = newValue.chars().allMatch(Character::isLetter);
                if (!isAllLetters) {
                    JOptionPane.showMessageDialog(this, "Category must consist of letters only.");
                    return;
                }
            ...
            case "SpecificType":
                ...
                if (!AllLetters) {
                    JOptionPane.showMessageDialog(this, "Specific Types must consist of letters only.");
                    return;
                }
                break;
